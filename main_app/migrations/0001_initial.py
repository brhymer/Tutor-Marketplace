# Generated by Django 3.0.6 on 2020-05-14 21:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson', models.ManyToManyField(to='main_app.Lesson')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson', models.ManyToManyField(null=True, to='main_app.Lesson')),
                ('student', models.ManyToManyField(null=True, to='main_app.Student')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
